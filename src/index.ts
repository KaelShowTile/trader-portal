...
app.get('/api/admin/products', async (c) => {
	const db = c.env.tile_db;
	const products = await db.prepare('SELECT DISTINCT cht_product_id, cht_product_name FROM products WHERE cht_product_id IS NOT NULL ORDER BY cht_product_name ASC').all();
